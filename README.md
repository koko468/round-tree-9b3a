...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/round-tree-9b3a)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/round-tree-9b3a
```

A live public deployment of this template is available at [https://round-tree-9b3a.templates.workers.dev](https://round-tree-9b3a.templates.workers.dev)
